...
# Node names
ANSWORKER1=40_answorker1_lab
ANSWORKER2=40_answorker2_lab
ANSWORKER3=40_answorker3_lab
ANSWORKER4=40_answorker4_lab
ANSWORKER5=40_answorker5_lab

# Ks files URLs
ANSWORK_KS_FILE1=http://rocky9.repo.local/ansible_lesspass/40_answorker1.cfg
ANSWORK_KS_FILE2=http://rocky9.repo.local/ansible_lesspass/40_answorker2.cfg
ANSWORK_KS_FILE3=http://rocky9.repo.local/ansible_lesspass/40_answorker3.cfg
ANSWORK_KS_FILE4=http://rocky9.repo.local/ansible_lesspass/40_answorker4.cfg
ANSWORK_KS_FILE5=http://rocky9.repo.local/ansible_lesspass/40_answorker5.cfg
...
# Storage names
VOL_ANSWORKER1=40_answorker1.qcow2
VOL_ANSWORKER2=40_answorker2.qcow2
VOL_ANSWORKER3=40_answorker3.qcow2
VOL_ANSWORKER4=40_answorker4.qcow2
VOL_ANSWORKER5=40_answorker5.qcow2
...
--network network=default,mac=52:54:00:9a:cb:40 \
--location ${REPO} \
...
--network network=default,mac=52:54:00:9a:cb:41 \
--location ${REPO} \
--vnc --autoconsole graphical \
...
--network network=default,mac=52:54:00:9a:cb:42 \
--location ${REPO} \
--vnc --autoconsole graphical \
...
--network network=default,mac=52:54:00:9a:cb:43 \
--location ${REPO} \
--vnc --autoconsole graphical \
...
--network network=default,mac=52:54:00:9a:cb:44 \
--location ${REPO} \
--vnc --autoconsole graphical \
